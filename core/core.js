...
class DidiConsole {
   ...
   * add a new plugin
   * @public
   * @param object DidiConsolePlugin object
   * @return boolean
   */
  addPlugin(plugin) {
    ...
    // init plugin only if didiConsole is ready
    if (this.isReady) {
  ...
  removePlugin(pluginID) {
    ...
    // the plugin will not be initialized before didiConsole is ready,
